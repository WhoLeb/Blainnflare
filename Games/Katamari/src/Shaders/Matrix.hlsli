...
float3x3 Inverse3x3(float3x3 M)
{
    ...
    float3x3 inv;
    inv[0].x = (M[1].y * M[2].z - M[1].z * M[2].y) * invDet;
    inv[1].x = (M[0].z * M[2].y - M[0].y * M[2].z) * invDet;
    inv[2].x = (M[0].y * M[1].z - M[0].z * M[1].y) * invDet;
    inv[0].y = (M[1].z * M[2].x - M[1].x * M[2].z) * invDet;
    inv[1].y = (M[0].x * M[2].z - M[0].z * M[2].x) * invDet;
    inv[2].y = (M[0].z * M[1].x - M[0].x * M[1].z) * invDet;
    inv[0].z = (M[1].x * M[2].y - M[1].y * M[2].x) * invDet;
    inv[1].z = (M[0].y * M[2].x - M[0].x * M[2].y) * invDet;
    inv[2].z = (M[0].x * M[1].y - M[0].y * M[1].x) * invDet;
    return inv;
}
